...
CudaRasterizer::GeometryState CudaRasterizer::GeometryState::fromChunk(char*& chunk, size_t P)
{
	...
	obtain(chunk, geom.pos_view, P , 128);  		// float*
...
void CudaRasterizer::Rasterizer::SSAO(
	const int width, const int height,
	const float focal_x,
	const float focal_y,
...
void CudaRasterizer::Rasterizer::SSR(
	const int width, const int height,
	const float focal_x,
	const float focal_y,
	const float radius,  //0.8
...
void CudaRasterizer::Rasterizer::SSR_BACKWARD(
	const int width, const int height,
	const float focal_x,
	const float focal_y,
	const float* out_normal,
...
int CudaRasterizer::Rasterizer::forward(
	...
	const float* semantic,			// [P, 20] // 新增
	const float* flow,				// [P, 2] // 新增
	...
	float* out_normal_view,		// [3, H, W]
	float* out_pos,			// [3, H, W]
	float* out_albedo,		// [3, H, W]
	float* out_roughness,	// [1, H, W]
	float* out_metallic,	// [1, H, W]
	float* out_semantic,	// [20, H, W] // 新增
	float* out_flow,		// [2, H, W] // 新增
	int* radii,				// [P]
	bool debug)
{
	const float focal_y = height / (2.0f * tan_fovy);
	...
	const float* semantic_ptr = semantic; // 新增
	const float* flow_ptr = flow; // 新增
...
void CudaRasterizer::Rasterizer::backward(
	...
	const float* dL_dpix_semantic,	// [20, H, W] // 新增
	const float* dL_dpix_flow,		// [2, H, W]
	float* dL_dmean2D,
	float* dL_dconic,
	float* dL_depth,
	float* dL_dopacity,
	...
	float* dL_droughness,
	float* dL_dmetallic,
	float* dL_dsemantic,	// [20, H, W] // 新增
	float* dL_dflow,		// [2, H, W]
	float* dL_dcolor,
	float* dL_dmean3D,
	float* dL_dcov3D,
	float* dL_dsh,
