...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        semantic: torch.Tensor,  #语义渲染
        flow: torch.Tensor,      #光流渲染
        sh: torch.Tensor,
    ...
    def backward(
        ...
        grad_out_semantic: Optional[torch.Tensor] = None,  # 新增
        grad_out_flow: Optional[torch.Tensor] = None,  # 新增
